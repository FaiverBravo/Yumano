...
// Control de zoom en la esquina superior izquierda (debajo de la barra de búsqueda)
L.control.zoom({ position: 'topleft' }).addTo(mapa);

// Activar zoom con rueda al hacer clic o interactuar con el mapa, y desactivarlo al salir
