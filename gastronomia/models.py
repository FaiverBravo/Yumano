...
class Gastronomia(models.Model):
    usuario = models.ForeignKey(Usuario, on_delete=models.CASCADE, related_name='gastronomias', null=True, blank=True)
    ...
    carta = models.FileField(upload_to='gastronomia_cartas', null=True, blank=True, help_text="Sube la carta/menú (PDF o Imagen)")
